...
class MainActivity : AppCompatActivity() {
        ...
        internalStoragePhotoAdapter = InternalStoragePhotoAdapter {
            lifecycleScope.launch {
                ...
                if (isDeletionSuccessful) {
                    ...
                    Toast.makeText(this@MainActivity, "Photo is deleted successfully!", Toast.LENGTH_SHORT).show()
                } else {
        ...
        val takePhotos = registerForActivityResult(ActivityResultContracts.TakePicturePreview()) {
            lifecycleScope.launch {
                ...
                if (isSavedSuccessfully) {
                    Toast.makeText(this@MainActivity, "Photo is saved successfully!", Toast.LENGTH_SHORT).show()
                } else {
    ...
    private fun updateOrRequestPermission() {
        ...
        if (permissionToRequest.isNotEmpty()) {
            permissionResultLauncher.launch(permissionToRequest.toTypedArray())
        }
    }
    ...
    private suspend fun savePhotoToInternalStorage(fileName: String, bitmap: Bitmap): Boolean {
        return withContext(Dispatchers.IO) {
            try {
                openFileOutput("${fileName}.jpg", MODE_PRIVATE).use { fos ->
